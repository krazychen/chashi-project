...
//    LoginSysUserTokenVo wxLogin(WxQueryParam wxQueryParam);
//
//    LoginSysUserTokenVo wxLogin1(WxQueryParam wxQueryParam);

    LoginSysUserTokenVo checkLoginQr(String code) throws Exception;
}
