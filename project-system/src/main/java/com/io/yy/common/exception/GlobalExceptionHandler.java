...
public class GlobalExceptionHandler {
     ...
     * @return
     */
    @ExceptionHandler(value = {WhyySystemException.class})
    @ResponseStatus(HttpStatus.OK)
    public ApiResult springBootPlusExceptionHandler(WhyySystemException exception) {
        log.error("whyy system xception:", exception);
        int errorCode;
