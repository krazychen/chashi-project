...
import com.io.yy.core.properties.WhyySystemCorsProperties;
...
@Slf4j
@Configuration
public class WhyySystemCorsConfig {
     ...
     */
    @Bean
    public FilterRegistrationBean corsFilter(WhyySystemCorsProperties corsProperties) {
