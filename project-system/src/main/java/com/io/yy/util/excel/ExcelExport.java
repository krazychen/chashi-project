...
import com.io.yy.util.excel.annotation.ExcelField.Align;
...
//			}
	...
	public ExcelExport write(HttpServletResponse response, String fileName){
		...
		// 下载文件的默认名称
		response.setHeader("Content-Disposition", "attachment;filename="+ EncodeUtils.encodeUrl(fileName,"utf-8"));
		response.setHeader("FileName", EncodeUtils.encodeUrl(fileName,"utf-8"));
