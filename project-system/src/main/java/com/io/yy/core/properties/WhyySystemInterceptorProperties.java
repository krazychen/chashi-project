 ...
 */
@Data
@ConfigurationProperties(prefix = "whyy-system.interceptor")
public class WhyySystemInterceptorProperties {
     ...
     */
    @NestedConfigurationProperty
    private InterceptorConfig configResource = new InterceptorConfig();
