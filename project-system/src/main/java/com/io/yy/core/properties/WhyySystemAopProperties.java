...
@Data
@Component
@ConfigurationProperties(prefix = "whyy-system.aop")
public class WhyySystemAopProperties {
    ...
    public static class LoginLogConfig {
         ...
         * 登录路径
         */
        private Set<String> loginPath = new HashSet<String>(Arrays.asList("login","wx/login"));
