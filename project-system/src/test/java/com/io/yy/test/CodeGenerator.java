...
import com.io.yy.generator.config.WhyySystemMySqlQuery;
import lombok.Data;
...
public class CodeGenerator {
    ...
    public void generator() {
        ...
        gc.setIdType(IdType.ASSIGN_ID);     // 主键类型:ID_WORKER
        ...
        // 设置自定义查询
        dsc.setDbQuery(new WhyySystemMySqlQuery());
        ...
        // createBy createTime 字段在插入时会更改为你设定的值  填充值我通过config去配置的详见下文
        TableFill createByField = new TableFill("createBy", FieldFill.INSERT);
        TableFill createTimeField = new TableFill("createTime", FieldFill.INSERT);
        // updateBy updateTime 字段在插入和更新时会更改为你设定的值
        TableFill updateByField = new TableFill("updateBy", FieldFill.INSERT_UPDATE);
        TableFill updateTimeField = new TableFill("updateTime", FieldFill.INSERT_UPDATE);
