...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`whyy-system` /*!40100 DEFAULT CHARACTER SET utf8mb4  */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
) ENGINE=InnoDB AUTO_INCREMENT=526718 DEFAULT CHARSET=utf8mb4  COMMENT='IP地址';
...
CREATE TABLE `sys_office` (
  ...
  `remarks` varchar(500) DEFAULT NULL COMMENT '备注信息',
  `corp_code` varchar(64) NOT NULL DEFAULT '0' COMMENT '租户代码',
  `corp_name` varchar(100) CHARACTER SET utf8mb4  NOT NULL DEFAULT 'whyy' COMMENT '租户名称',
...
CREATE TABLE `sys_user` (
  ...
  `reg_type` varchar(64) CHARACTER SET utf8mb4  DEFAULT '1' COMMENT '开通方式（1:手工;2:注册;3:导入;）',
...
insert  into `sys_user`(`id`,`username`,`nickname`,`password`,`salt`,`email`,`mobile`,`phone`,`gender`,`avatar`,`signtext`,`wx_openid`,`mobile_imei`,`user_type`,`ref_code`,`ref_name`,`mgr_type`,`reg_type`,`pwd_security_level`,`pwd_update_date`,`pwd_update_record`,`pwd_question`,`pwd_question_answer`,`pwd_question_2`,`pwd_question_answer_2`,`pwd_question_3`,`pwd_question_answer_3`,`pwd_quest_update_date`,`last_login_ip`,`last_login_date`,`freeze_date`,`freeze_cause`,`user_weight`,`remarks`,`department_id`,`role_id`,`state`,`deleted`,`version`,`create_by`,`create_time`,`update_by`,`update_time`,`corp_code`,`corp_name`) values 
(1,'admin','管理员','11a254dab80d52bc4a347e030e54d861a9d2cdb2af2185a9ca4a7318e830d04d','66',NULL,NULL,'13950019129',1,'http://localhost:8888//resource/201911102329033.png',NULL,NULL,NULL,'1',NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,1,1,1,0,0,'1','2019-11-23 10:42:01','1',NULL,'0','whyy');
